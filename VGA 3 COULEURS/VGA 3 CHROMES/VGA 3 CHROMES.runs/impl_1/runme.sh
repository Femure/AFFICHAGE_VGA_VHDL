...
HD_PWD='C:/Users/maxim/VHDL/FPGA/AFFICHAGE VGA/VGA 3 COULEURS/VGA 3 CHROMES/VGA 3 CHROMES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_3_chromes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_3_chromes.tcl -notrace
